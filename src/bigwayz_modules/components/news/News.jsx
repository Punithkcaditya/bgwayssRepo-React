...
// api services
import { _logout, _getHistory, _getNewsData } from "../../config/api/Api";
// loader
                                            ...
                                            this.state.news && this.state.news.map((item, index) => (
                                                <div className="news-card" key = {index}>
                                                    ...
                                                    <div className="news-text">
                                                        <h5>{item.description.news_text}</h5>
                                                        <p>{item.description.news_short_desc}</p>
                                                        <div>
                                                        <Link to={`news/${item.id}`} className="btn-one btn btn-primary">Read More</Link>
                                                        </div>
                                                    </div>
                                                </div>
